...
if __name__ == "__main__":
    BASE_URL = "https://ua.korrespondent.net/all/2025/march/1/"
    FILE_NAME = "news.csv"
    # filter_date_inp can be None. In this case filtering would not be applied
    filter_d: Dict[str, str] = {"start_date": "2025-03-01 00:00",
                                "end_date": "2025-03-05 23:59"}
    save_to_csv(scrape_all_pages(BASE_URL, filter_d), FILE_NAME)
    # get file statistics with pandas
